<?php
namespace Magenest\StripePayment\Model\StripePaymentMethod;

/**
 * Interceptor class for @see \Magenest\StripePayment\Model\StripePaymentMethod
 */
class Interceptor extends \Magenest\StripePayment\Model\StripePaymentMethod implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Framework\Model\Context $context, \Magento\Framework\Registry $registry, \Magento\Framework\Api\ExtensionAttributesFactory $extensionFactory, \Magento\Framework\Api\AttributeValueFactory $customAttributeFactory, \Magento\Payment\Helper\Data $paymentData, \Magento\Framework\App\Config\ScopeConfigInterface $scopeConfig, \Magento\Payment\Model\Method\Logger $logger, \Magento\Framework\Module\ModuleListInterface $moduleList, \Magento\Framework\Stdlib\DateTime\TimezoneInterface $localeDate, \Magenest\StripePayment\Helper\Data $dataHelper, \Magenest\StripePayment\Helper\Config $config, \Magenest\StripePayment\Helper\Logger $stripeLogger, \Magenest\StripePayment\Model\CardFactory $cardFactory, \Magento\Customer\Model\Session $customerSession, \Magento\Framework\Message\ManagerInterface $messageManager, \Magento\Store\Model\StoreManagerInterface $storeManagerInterface, \Magento\Framework\App\RequestInterface $request, $data = array())
    {
        $this->___init();
        parent::__construct($context, $registry, $extensionFactory, $customAttributeFactory, $paymentData, $scopeConfig, $logger, $moduleList, $localeDate, $dataHelper, $config, $stripeLogger, $cardFactory, $customerSession, $messageManager, $storeManagerInterface, $request, $data);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addPaymentInfoData');
        if (!$pluginInfo) {
            return parent::addPaymentInfoData($infoInstance, $_cardID);
        } else {
            return $this->___callPlugins('addPaymentInfoData', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function placeOrder($payment, $amount, $paymentAction)
    {
        ...
        if (!$pluginInfo) {
            return parent::placeOrder($payment, $amount, $paymentAction);
        } else {
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'perform3dSecure');
        if (!$pluginInfo) {
            return parent::perform3dSecure($payment, $amount);
        } else {
            return $this->___callPlugins('perform3dSecure', func_get_args(), $pluginInfo);
        }
    }
