<?php
namespace ICEShop\ICECatConnect\Model\Action;

/**
 * Interceptor class for @see \ICEShop\ICECatConnect\Model\Action
 */
class Interceptor extends \ICEShop\ICECatConnect\Model\Action implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Eav\Model\Entity\Context $context, \Magento\Store\Model\StoreManagerInterface $storeManager, \Magento\Catalog\Model\Factory $modelFactory, $data = array())
    {
        $this->___init();
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, '_saveAttributeValue');
        if (!$pluginInfo) {
            return parent::_saveAttributeValue($object, $attribute, $value);
        } else {
            return $this->___callPlugins('_saveAttributeValue', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, '_processAttributeValues');
        if (!$pluginInfo) {
            return parent::_processAttributeValues();
        } else {
            return $this->___callPlugins('_processAttributeValues', func_get_args(), $pluginInfo);
        }
    }
     ...
     * {@inheritdoc}
     */
    public function _prepareValueForSave($value, \Magento\Eav\Model\Entity\Attribute\AbstractAttribute $attribute)
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, '_prepareValueForSave');
        if (!$pluginInfo) {
            return parent::_prepareValueForSave($value, $attribute);
        } else {
            return $this->___callPlugins('_prepareValueForSave', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function addAttributeByScope(\Magento\Eav\Model\Entity\Attribute\AbstractAttribute $attribute, $entity = null)
    {
        ...
        if (!$pluginInfo) {
            return parent::addAttributeByScope($attribute, $entity);
        } else {
