 ...
 */
namespace Sparx\Delivery\Model\Carrier;
    ...
    \Magento\Shipping\Model\Carrier\CarrierInterface
{
    ...
    /**
     * @var \Sparx\Delivery\Model\ResourceModel\Carrier\MatrixrateFactory
     */
     ...
     * @param \Sparx\Delivery\Model\ResourceModel\Carrier\MatrixrateFactory $matrixrateFactory
     * @param array $data
    ...
    public function __construct(
        ...
        \Sparx\Delivery\Model\ResourceModel\Carrier\MatrixrateFactory $matrixrateFactory,
        array $data = []
    ) {
    ...
    public function collectRates(RateRequest $request)
    {
       ...
       // $this->_logger->info(100,print_r($request,true));
       // $this->_logger->info(100,print_r($zipRange,true));
        ...
        foreach ($rateArray as $rate) {
            ...
            if (!empty($rate) && $rate['price'] >= 0) {
                ...
                $method->setMethod('delivery_' . $rate['pk']);
    ...
    {
        return ['delivery' => $this->getConfigData('name')];
    }
}
